...
def test1():
    global lable
    lable = Label(Main, text="0", bg='#333333', fg='#FFFFFF')
    ...
    def restart():
        ...
        lable = Label(Main, text=clicks, bg='#333333', fg='#FFFFFF')
        lable.grid(column=0, row=0, columnspan=3)

        clicker = Button(Main, text="click", bg='#333333', command=click, pady=10, padx=10, state='normal')
    ...
    def click():
        ...
        if numberoftime == 0:
            ...
            if timer == 0:
                ...
                clicker = Button(Main, text="click", bg='#333333', command=click, pady=10, padx=10, state='disabled')
                clicker.grid(column=0, row=1, columnspan=2)
                ...
                if CPS > 0:
                    cps = clicks/input_of_time
                    score = Label(Main, text=(cps, "CPS"), bg='#333333', fg='#FFFFFF')
                ...
                reset = Button(Main, text="Restart", bg='#333333', highlightbackground='#333333', command=restart)
    ...
    clicker = Button(Main, text="click", bg='#333333', command=click, pady=10, padx=10)
    ...
    back = Button(mainWindow, text=("back"), bg='#333333',highlightbackground='#333333', command=kill)
...
def test3():
    ...
    def restart():
        ...
        lable = Label(Main, text=clicks, fg='#FFFFFF')
        lable.grid(column=0, row=0, columnspan=3)
    ...
    def click():
        ...
        if numberoftime == 0:
            ...
            if timer == 0:
                ...
                if CPS > 0:
                    cps = clicks/input_of_time
                    score = Label(Main, text=(cps, "CPS"), fg='#FFFFFF')
                    score.grid(column=0, row=3, columnspan=2)
                else:
                    cps = clicks//input_of_time
                    score = Label(Main, text=(cps, "CPS"), fg='#FFFFFF')
    ...
    def custom():
        ...
        def run():
            ...
            try:
                ...
                E4 = Label(Main, text="Thats not a number", fg='#FFFFFF')
                E4.grid(column=0, row=3, columnspan=2)
                E4 = Label(Main, text="Try again..", fg='#FFFFFF')
        ...
        E2 = Label(Main, text="Duration of test?" ,bg='#333333', fg='#FFFFFF')
        E2.grid(column=0, row=0, sticky=W)
        E3 = Button(Main, text="Submit", highlightbackground='#333333', command=run)
        E3.grid(column=0, row=2, columnspan=2)
        E4 = Label(Main ,bg='#333333', fg='#FFFFFF')
        E4.grid(column=0, row=3, columnspan=2)
        def clear1():
            E1.destroy()
            E2.destroy()
        ...
        def click():
            ...
            if numberoftime == 0:
                ...
                if timer == 0:
                    ...
                    reset = Button(Main, text="Restart", highlightbackground='#333333', command=restart)
                    reset.grid(column=0, row=4, columnspan=2)  
                else:
                    clicks += 1
                    lable.destroy()
